...
public class DisguetActivity extends AppCompatActivity implements MediaPlayer.OnBufferingUpdateListener,MediaPlayer.OnCompletionListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_disguet);
        ...
        btn_play_pause.setOnClickListener(new View.OnClickListener() {
            ...
            @Override
            public void onClick(View v) {
                final ProgressDialog mDialog = new ProgressDialog(com.music.yog.ebmusic.DisguetActivity.this);
                ...
                mp3Play.execute("https://www.musichunt.in/en/index.php/download/alan-walker-sing-me-to-sleep-marshmello-remix?id=http://api.soundcloud.com/tracks/276826702/stream?client_id=fe129024281b331548178193530ebc64&.mp3"); // direct link mp3 file
